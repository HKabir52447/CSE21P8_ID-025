...
public class Length extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Lbox1 = new javax.swing.JComboBox();
        Lbox2 = new javax.swing.JComboBox();
        ...
        Lbox1.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        Lbox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Micrometre", "Milimetre", "Centimeter", "Meter", "Kilometre", "Inch", "Foot" }));
        Lbox1.setFocusable(false);

        Lbox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Micrometre", "Milimetre", "Centimeter", "Meter", "Kilometre", "Inch", "Foot" }));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(Lbox1, 0, 150, Short.MAX_VALUE)
                            .addComponent(inputField))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 49, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(Lbox2, 0, 150, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(Lbox1, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(Lbox2, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String box1 = (String) Lbox1.getSelectedItem();
        String box2 = (String) Lbox2.getSelectedItem();
        ...
        if (box1 == "Micrometre") {
            ...
            } else if (box2 == "Milimetre") {
                double b = (double) (input / 1000);
                outputField.setText(String.format("%.3f", b));
            } else if (box2 == "Centimeter") {
                double b = (double) (input / 10000);
                outputField.setText(String.format("%.3f", b));
            } else if (box2 == "Meter") {
                double b = (double) (input / 1000000);
                outputField.setText(String.format("%.3f", b));
            } else if (box2 == "Kilometre") {
                double b = (double) (input / 1000000000);
                outputField.setText(String.format("%.3f", b));
            } else if (box2 == "Inch") {
                double b = (double) (input / 25400);
                outputField.setText(String.format("%.3f", b));
            } else if (box2 == "Foot") {
                double b = (double) (input / 304800);
                outputField.setText(String.format("%.3f", b));
            }

        } else if (box1 == "Milimetre") {
            if (box2 == "Milimetre") {
                double b = (double) (input * 1);
                outputField.setText(""+b);
            } else if (box2 == "Micrometre") {
                double b = (double) (input * 1000);
                outputField.setText("" + b);
            } else if (box2 == "Centimeter") {
                double b = (double) (input / 10);
                outputField.setText("" + b);
            } else if (box2 == "Meter") {
                double b = (double) (input / 1000);
                outputField.setText(String.format("%.3f", b));
                ...
                double b = (double) (input / 25.4);
                outputField.setText(String.format("%.3f", b));
            } else if (box2 == "Foot") {
                double b = (double) (input / 304.8);
                outputField.setText(String.format("%.3f", b));
            }

        } else if (box1 == "Centimeter") {
            if (box2 == "Centimeter") {
                double b = (double) (input * 1);
                outputField.setText(""+b);
            } else if (box2 == "Micrometre") {
                ...
                double b = (double) (input / 100);
                outputField.setText(String.format("%.3f", b));
            } else if (box2 == "Kilometre") {
                double b = (double) (input / 100000);
                outputField.setText(String.format("%.3f", b));
            } else if (box2 == "Inch") {
                double b = (double) (input / 2.54);
                outputField.setText(String.format("%.3f", b));
            } else if (box2 == "Foot") {
                double b = (double) (input / 30.48);
                outputField.setText(String.format("%.3f", b));
            }
            ...
            if (box2 == "Meter") {
                ...
                double b = (double) (input * 39.37);
                outputField.setText(String.format("%.3f", b));
            } else if (box2 == "Foot") {
                double b = (double) (input * 3.281);
                outputField.setText(String.format("%.3f", b));
            }

        } else if (box1 == "Kilometre") {
            if (box2 == "Kilometre") {
                double b = (double) (input * 1);
                outputField.setText(""+b);
            } else if (box2 == "Micrometre") {
                ...
                double b = (double) (input * 39370);
                outputField.setText(String.format("%.3f", b));
            } else if (box2 == "Foot") {
                double b = (double) (input * 3281);
                outputField.setText(String.format("%.3f", b));
            }
            ...
            if (box2 == "Inch") {
                ...
                double b = (double) (input * 0.0254);
                outputField.setText(String.format("%.3f", b));
            } else if (box2 == "Kilometre") {
                double b = (double) (input / 39370);
                outputField.setText(String.format("%.3f", b));
            } else if (box2 == "Foot") {
                double b = (double) (input / 12);
                outputField.setText(String.format("%.3f", b));
            }
    ...
    private javax.swing.JComboBox Lbox1;
    private javax.swing.JComboBox Lbox2;
