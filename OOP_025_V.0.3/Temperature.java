...
public class Temperature extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Tbox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Celsius", "Fahrenheit", "Kelvin" }));
        Tbox1.setFocusable(false);

        Tbox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Celsius", "Fahrenheit", "Kelvin" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double input = Double.parseDouble(inputField.getText());
         if (box1 == "Celsius") {
            ...
            } else if (box2 == "Fahrenheit") {
                double b = (double) ((input * 9/5) + 32);
                outputField.setText(String.format("%.3f", b));
            } else if (box2 == "Kelvin") {
                double b = (double) (input + 273.15);
                outputField.setText(String.format("%.3f", b));
            } 
         }
        else if (box1 == "Fahrenheit") {
            if (box2 == "Fahrenheit") {
                double b = (double) (input * 1);
                outputField.setText(""+b);
            } else if (box2 == "Celsius") {
                double b = (double) ((input - 32) * 5/9);
                outputField.setText(String.format("%.3f", b));
            } else if (box2 == "Kelvin") {
                double b = (double) ((input - 32) * 5/9 + 273.15);
                outputField.setText(String.format("%.3f", b));
            } 
         }
         else if (box1 == "Kelvin") {
            if (box2 == "Kelvin") {
                ...
                double b = (double) ((input - 273.15) * 9/5 + 32);
                outputField.setText(String.format("%.3f", b));
            } 
         }
