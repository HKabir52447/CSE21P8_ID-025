...
public class Area extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Abox1 = new javax.swing.JComboBox();
        Abox2 = new javax.swing.JComboBox();
        ...
        Abox1.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        Abox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Square kilometer", "Square meter", "Acre", "Hectare" }));
        Abox1.setFocusable(false);

        Abox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Square kilometer", "Square meter", "Acre", "Hectare" }));
        Abox2.setFocusable(false);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(Abox1, 0, 150, Short.MAX_VALUE)
                            .addComponent(inputField))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 49, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(Abox2, 0, 150, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(Abox1, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(Abox2, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String box1 = (String) Abox1.getSelectedItem();
        String box2 = (String) Abox2.getSelectedItem();
        double input = Double.parseDouble(inputField.getText());
         if (box1 == "Square meter") {
            if (box2 == "Square meter") {
                double b = (double) (input * 1);
                outputField.setText(""+b);
            } else if (box2 == "Square kilometer") {
                double b = (double) (input * 1e-6);
                outputField.setText(String.format("%.3f", b));
            } else if (box2 == "Acre") {
                double b = (double) (input / 4047);
                outputField.setText(String.format("%.3f", b));
            
            } else if (box2 == "Hectare") {
                double b = (double) (input * 1e-4);
                outputField.setText(String.format("%.3f", b));
            } 
         }
         else if (box1 == "Square kilometer") {
            if (box2 == "Square kilometer") {
                double b = (double) (input * 1);
                outputField.setText(""+b);
            } else if (box2 == "Square meter") {
                double b = (double) (input * 1e6);
                outputField.setText(String.format("%.3f", b));
            } else if (box2 == "Acre") {
                double b = (double) (input * 247.1);
                outputField.setText(String.format("%.3f", b));
            ...
            if (box2 == "Acre") {
                ...
                double b = (double) (input / 2.471);
                outputField.setText(String.format("%.3f", b));
            } 
         }
         else if (box1 == "Hectare") {
            if (box2 == "Hectare") {
                double b = (double) (input * 1);
                outputField.setText(""+b);
            } else if (box2 == "Square meter") {
    ...
    private javax.swing.JComboBox Abox1;
    private javax.swing.JComboBox Abox2;
